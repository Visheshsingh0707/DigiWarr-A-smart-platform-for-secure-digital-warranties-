...
import { Shield, Lock, FileText, ArrowRight, CheckCircle2, Zap, Bell, Eye, ExternalLink, Globe, Mail, Store, Users, Sparkles, Star, X } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <AnimatedSection key={i} delay={i * 0.08}>
                <FloatingCard className="glass-card p-8 group h-full">
                  <div className={`h-14 w-14 rounded-2xl ${feature.bg} flex items-center justify-center mb-6 transition-transform group-hover:scale-110`}>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="relative z-10 py-24 bg-[var(--bg-primary)]">
        <div className="max-w-4xl mx-auto px-6">
          <AnimatedSection className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">How It Works</h2>
            <p className="text-[var(--text-muted)] max-w-xl mx-auto">Three simple steps to secure your documents forever.</p>
          </AnimatedSection>
            ...
            {steps.map((item, i) => (
              <AnimatedSection key={i} delay={i * 0.15}>
                <div className="flex items-start gap-6">
                  <div className={`flex-shrink-0 h-14 w-14 rounded-2xl bg-gradient-to-br ${item.gradient} flex items-center justify-center shadow-lg`}>
                    <item.icon className="h-7 w-7 text-white" />
                  </div>
                  <div>
                    <div className="text-xs font-bold text-[var(--text-muted)] uppercase tracking-widest mb-1">Step {item.step}</div>
                    <h3 className="text-xl font-bold mb-2">{item.title}</h3>
                    <p className="text-[var(--text-secondary)] leading-relaxed max-w-lg">{item.desc}</p>
                  </div>
                </div>
              </AnimatedSection>
            ))}
      ...
      {/* Pricing Section */}
      <section id="pricing" className="relative z-10 py-24 bg-[var(--bg-secondary)] border-y border-[var(--border)]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <AnimatedSection delay={0.1}>
              <FloatingCard className="glass-card p-8 h-full flex flex-col">
                <div className="mb-6">
            ...
            <AnimatedSection delay={0.2}>
              <FloatingCard className="glass-card p-8 h-full flex flex-col relative border-brand-500/30 bg-brand-500/5">
